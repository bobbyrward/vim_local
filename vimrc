...
set printoptions=paper:letter,duplex:off,collate:y,syntax:n
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
   ...
   set tags+=$HOME/vim_local/tags/python.ctags
...
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
function! FMSSource()
    exe "cd ~/src/finarta/fms"
endfunction

function! CombustionSource()
    exe "cd ~/src/combustion"
endfunction

map z1 :call FMSSource()<cr>
map z2 :call combustion()<cr>
